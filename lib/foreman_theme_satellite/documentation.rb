...
module ForemanThemeSatellite
  module Documentation
    USER_GUIDE_DICTIONARY = {
      # Ansible
      'ImportingRoles' => "#{ForemanThemeSatellite.documentation_root}/configuring_red_hat_satellite_to_use_ansible/getting-started-with-ansible_ansible#importing-Ansible-roles_ansible",
      'Variables' => "#{ForemanThemeSatellite.documentation_root}/configuring_red_hat_satellite_to_use_ansible/getting-started-with-ansible_ansible#overriding-Ansible-variables_ansible",
      ...
      'ParameterizedClasses' => "#{ForemanThemeSatellite.documentation_root}/managing_configurations_using_puppet_integration_in_red_hat_satellite/importing_puppet_classes_and_environments_managing-configurations-puppet#doc-wrapper",
      ...
      'LDAPAuthentication' => "#{ForemanThemeSatellite.documentation_root}/administering_red_hat_satellite/configuring_external_authentication_admin#Using_LDAP_admin",
      'Bookmarks' => "#{ForemanThemeSatellite.documentation_root}/administering_red_hat_satellite/searching_and_bookmarking_admin",
      'Policydeploymentoptions' => "#{ForemanThemeSatellite.documentation_root}/administering_red_hat_satellite/managing_security_compliance_admin#Managing_Compliance_Policies_admin",
      'CreatingSCAPcontent' => "#{ForemanThemeSatellite.documentation_root}/administering_red_hat_satellite/running_openscap_scans_admin",
