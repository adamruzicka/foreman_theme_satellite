module ThemeApplicationHelper
  ...
  USER_GUIDE_DICTIONARY = {
    ...
    "Realm" => "https://access.redhat.com/documentation/en-us/red-hat-satellite/#{ForemanThemeSatellite::SATELLITE_SHORT_VERSION}/html/server_administration_guide/sect-red_hat_satellite-server_administration_guide-configuring_external_authentication-external_authentication_for_provisioned_hosts#sect-Red_Hat_Satellite-Server_Administration_Guide-External_Authentication_for_Provisioned_Hosts-Configuring_a_Red_Hat_Satellite_Server_or_Capsule_Server_for_IdM_Realm_Support",
    ...
    "GettingHelp" => "https://access.redhat.com/documentation/en-us/red_hat_satellite/#{ForemanThemeSatellite::SATELLITE_SHORT_VERSION}/html/transition_guide/",
