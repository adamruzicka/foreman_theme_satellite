...
module ThemeApplicationHelper
  ...
  USER_GUIDE_DICTIONARY = {
    ...
    'ParameterizedClasses' => "#{ForemanThemeSatellite.documentation_root}/provisioning_guide/",
    ...
    'Parameters' => "#{ForemanThemeSatellite.documentation_root}/provisioning_guide/",
